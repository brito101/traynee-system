...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-fw fa-box"></i> Editar Produto</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form method="POST" action="{{ route('admin.products.update', ['product' => $product->id]) }}">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control" id="price_id" placeholder="price_..."
                                            name="price_id" value="{{ old('price_id') ?? $product->price_id }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap justify-content-between px-3">
                                <div class="col-12 form-group px-1">
                                    ...
                                    <x-adminlte-textarea name="description" placeholder="Insira a descrição do produto...">
