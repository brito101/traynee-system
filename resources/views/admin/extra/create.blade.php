...
@section('title', '- Cadastro de Curso Extracurricular')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-fw fa-plus"></i> Novo Curso Extracurricular</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Novo Curso Extracurricular</li>
                    </ol>
                </div>
            </div>
        </div>
