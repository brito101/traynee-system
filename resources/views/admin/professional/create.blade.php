...
@section('title', '- Cadastro de Experiência Profissional')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-fw fa-briefcase"></i> Nova Experiência Profissional</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.professionals.index') }}">Experiências
                                Profissionais</a></li>
                        <li class="breadcrumb-item active">Nova Experiência Profissional</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control date" id="end"
                                            placeholder="Data do Término (anulável)" name="end" value="{{ old('end') }}">
                                    </div>
                                </div>
