...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-map"></i> Editar Endereço</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Dados Cadastrais de Endereço</h3>
                        </div>

                        <form method="POST" action="{{ route('admin.address.store', ['user' => $user->id]) }}"
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control" id="street" placeholder="Rua"
                                            name="street" value="{{ old('street') ?? $user->street }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="number" placeholder="Número"
                                            name="number" value="{{ old('number') ?? $user->number }}" required>
                                    </div>
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        <label for="complement">Complemento</label>
                                        <input type="text" class="form-control" id="complement" placeholder="Complemento"
                                            name="complement" value="{{ old('complement') ?? $user->complement }}">
                                    </div>
                                </div>
