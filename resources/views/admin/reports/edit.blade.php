...
@section('title', '- Edição de Relatório de Estágio')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-file-download"></i> Editar Relatório de Estágio</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.reports.index') }}">Relatórios de
                                Estágio</a></li>
                        <li class="breadcrumb-item active">Editar Relatório de Estágio</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <x-adminlte-select2 name="type">
                                            <option
                                                {{ old('type') == 'Aproveitamento' ? 'selected' : ($report->type == 'Aproveitamento' ? 'selected' : '') }}>
                                                Aproveitamento</option>
                                            <option
                                                {{ old('type') == 'Atividades' ? 'selected' : ($report->type == 'Atividades' ? 'selected' : '') }}>
                                                Atividades
                                            </option>
                                            <option
                                                {{ old('type') == 'Recibo de Conclusão'? 'selected': ($report->type == 'Recibo de Conclusão'? 'selected': '') }}>
                                                Recibo de
                                                Conclusão</option>
                                            <option
                                                {{ old('type') == 'Recibo de Desligamento'? 'selected': ($report->type == 'Recibo de Desligamento'? 'selected': '') }}>
                                                Recibo
                                                de Desligamento</option>
                                            <option
                                                {{ old('type') == 'Termo de Realização do Estágio'? 'selected': ($report->type == 'Termo de Realização do Estágio'? 'selected': '') }}>
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <x-adminlte-select2 name="company_id">
                                            @foreach ($companies as $company)
                                                <option
                                                    {{ old('company_id') == $company->id ? 'selected' : ($report->company_id == $company->id ? 'selected' : '') }}
                                                    value="{{ $company->id }}">
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <x-adminlte-select2 name="institution">
                                            @foreach ($institutions as $institution)
                                                <option
                                                    {{ old('institution') == $institution->id? 'selected': ($report->institution == $institution->id? 'selected': '') }}
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2">
                                        ...
                                        <x-adminlte-select2 name="trainee">
                                            @foreach ($trainees as $trainee)
                                                <option
                                                    {{ old('trainee') == $trainee->id ? 'selected' : ($report->trainee == $trainee->id ? 'selected' : '') }}
                                                    value="{{ $trainee->id }}">
