...
<table class="table table-bordered table-striped">
  ...
  <tr>
    ...
    <td>
      <p>When set to <code>true</code>, adds two buttons to the top of the dropdown menu (<strong>Selecione tudo</strong> &amp; <strong>Desmarque tudo</strong>).</p>
    </td>
  </tr>
  <tr>
    <td>container</td>
  ...
  <tr>
    ...
    <td>string</td>
    <td><code>'Desmarque tudo'</code></td>
    <td>
  ...
  <tr>
    <td>selectAllText</td>
    <td>string</td>
    <td><code>'Selecione tudo'</code></td>
    <td>
...
hide.bs.select, hidden.bs.select, show.bs.select, and shown.bs.Selecione tudo have a `relatedTarget` property, whose value is the toggling anchor element.
